 ...
 * @license MIT
 * @notice Modified by Javier Gonzalez. I ended up including the entire library
 *  inside this module because of a configuration error in regards to how vite uses
 *  rollup to configure Node Dependencies.
 *
 */
/*jslint bitwise: true */
var root = {};
...
exports.handler = async function(event, context) {
  ...
  return {
    statusCode: 200,
    body: JSON.stringify({ root: merkleTree.getHexRoot() }),
  };
};
